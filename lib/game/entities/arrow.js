...
EntityArrow = ig.Entity.extend({
		...
		takeCameraFocus: function(){
			if(!this.nextName){
				ig.game.zoomTo(this, 2, 0.35, false, this.done.bind(this));
			} else {
				ig.game.zoomTo(this, 2, 0.35, false, this.doneNext.bind(this));
			}
		...
		doneNext: function(){
			...
			ig.game.zoomTo(entity, 2, 0.35, false, entity.activate.bind(entity));
		},
