...
EntityStoryText = ig.Entity.extend({
		...
		update: function() {
			...
			this.text3 = Math.floor(ig.game.checkPoints[0].pos.x - ig.game.player.pos.x);
			this.score = Math.floor(ig.game.player.pos.x) + ig.game.player.dataCollected * 1000;
			/* fix this biz
		...
		draw: function(){
			...
			ig.game.font.draw('SPD: ' + this.text2, this.pos.x + 10, this.pos.y + 290);
			ig.game.font.draw('NEXT: ' + this.text3, this.pos.x + 150, this.pos.y + 10);
			ig.game.font.draw('SCORE: ' + this.score, this.pos.x + 300, this.pos.y + 290);
			this.parent();
		},
