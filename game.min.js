...
if(last===true){this.gainSuperPower();}},go:function(dir){this.direction=dir;},forceBoost:function(duration){this.forceBoostTimer=new ig.Timer(duration);},update:function(){if(!this.frozen){if(this.trailPointSpawnTimer.delta()>0){if(this.rippleTimer.delta()>0){var randDir=1;if(Math.random()<0.5){randDir=-1;}
...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','impact.font','game.entities.player','game.entities.particle','game.entities.nonPlayer','game.entities.block','game.entities.platform','game.entities.barrier','game.entities.storyText','game.entities.startMenu','game.entities.debris','game.levels.test','game.levels.level01','plugins.scalingPlugin').defines(function(){MyGame=ig.Game.extend({font:new ig.Font('media/courier16_white.png'),big:false,scaleFactor:1,tweenColorsByTime:false,clearColor:'#af0c27',currentColor:'#af0c27',newColor:'#af0c27',defaultColor:'#af0c27',darkColor:'#100710',mediumDarkColor:'#320221',mainRedColor:'#af0c27',mainWhiteColor:'#f8f4f8',init:function(){ig.Sound.enabled=true;ig.game.initKeys();ig.game.loadMusicTracks();ig.game.loadSoundEffects();ig.game.slowMotionTimer=new ig.Timer(0);ig.game.loadGameMode('text');},loadMusicTracks:function(){ig.music.add('media/music/atmospheric2.*','atmospheric2');ig.music.loop=true;ig.music.volume=1;},loadSoundEffects:function(){ig.game.sfxHit=new ig.Sound('media/sound/sfx_hit.*');ig.game.sfxHit.volume=0.5;ig.game.sfxBoom=new ig.Sound('media/sound/boom.*');ig.game.sfxSuperBoom=new ig.Sound('media/sound/super_boom.*');ig.game.sfxText01=new ig.Sound('media/sound/sfx_text_01.*');ig.game.sfxText02=new ig.Sound('media/sound/sfx_text_02.*');ig.game.sfxText03=new ig.Sound('media/sound/sfx_text_03.*');ig.game.sfxText04=new ig.Sound('media/sound/sfx_text_04.*');ig.game.sfxText05=new ig.Sound('media/sound/sfx_text_05.*');ig.game.sfxText06=new ig.Sound('media/sound/sfx_text_06.*');ig.game.textSfx=[ig.game.sfxText01,ig.game.sfxText02,ig.game.sfxText03,ig.game.sfxText04,ig.game.sfxText05,ig.game.sfxText06];},playRandomTextSfx:function(){ig.game.textSfx[Math.round((ig.game.textSfx.length-1)*Math.random())].play();},translateColorToString:function(r,g,b){var rr=r.toString(16);var gg=g.toString(16);var bb=b.toString(16);if(rr.length<2){rr='0'+rr;}else if(gg.length<2){gg='0'+gg;}else if(bb.length<2){bb='0'+bb;}
